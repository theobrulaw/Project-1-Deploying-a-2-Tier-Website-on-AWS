...
Deployed a secure and scalable 2-tier web architecture on AWS with separated application and database layers using VPC networking and security best practices.

This project demonstrates foundational cloud architecture principles used in production environments.
# Lab Title
